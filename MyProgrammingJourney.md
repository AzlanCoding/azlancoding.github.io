...
function imageCarouselInit(){
  $(".image-carousel").each(function(){
    if ($(this).children("img, video").length > 0){
      ...
      $(this).children("img, video").each(function(){
        $(this).attr("onclick","openModal(this)");
